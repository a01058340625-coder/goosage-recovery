...
import com.goosage.api.view.study.PredictionMapper;
...
public class PredictionServiceImpl implements PredictionService {
    ...
    @Override
    public com.goosage.api.view.study.CoachPredictionView predict(
        ...
        return com.goosage.api.view.study.CoachPredictionView.of(
                com.goosage.api.view.study.CoachPredictionLevel.SAFE,
                com.goosage.api.view.study.CoachPredictionReasonCode.DEFAULT_FALLBACK,
                com.goosage.api.view.study.PredictionEvidence.from(input)
        );
    }

    // ✅ 새 계약(권장): StudySnapshot 기반으로 예측
    public com.goosage.api.view.study.CoachPredictionView predict(StudySnapshot snapshot) {
    	
    	System.out.println("HIT: predict(StudySnapshot) called");
    	
        var domainPred = engine.predict(snapshot);
        return PredictionMapper.toCoachView(domainPred);
    }

    // ✅ 기존에 넣어둔 "StudyState 단일 진실" 계약은 아직 정보가 부족하니, Snapshot으로 승격시키는 방향 권장
    //    일단은 compile 유지용으로 기본 fallback
    @Override
    public com.goosage.api.view.study.CoachPredictionView predict(StudyState state) {
        return com.goosage.api.view.study.CoachPredictionView.of(
                com.goosage.api.view.study.CoachPredictionLevel.SAFE,
                com.goosage.api.view.study.CoachPredictionReasonCode.DEFAULT_FALLBACK,
