...
public class PredictionServiceImpl implements PredictionService {
    ...
    @Override
    public com.goosage.infra.service.study.predict.model.Prediction predict(
        ...
        return com.goosage.infra.service.study.predict.model.Prediction.of(
                com.goosage.infra.service.study.predict.model.PredictionLevel.SAFE,
                com.goosage.infra.service.study.predict.model.PredictionReasonCode.DEFAULT_FALLBACK,
                com.goosage.infra.service.study.predict.model.PredictionEvidence.from(input)
        );
    }

    // ✅ 새 계약(권장): StudySnapshot 기반으로 예측
    public com.goosage.infra.service.study.predict.model.Prediction predict(StudySnapshot snapshot) {
    ...
    @Override
    public com.goosage.infra.service.study.predict.model.Prediction predict(StudyState state) {
        return com.goosage.infra.service.study.predict.model.Prediction.of(
                com.goosage.infra.service.study.predict.model.PredictionLevel.SAFE,
                com.goosage.infra.service.study.predict.model.PredictionReasonCode.DEFAULT_FALLBACK,
