...
public final class PredictionMapper {
    ...
    public static com.goosage.infra.service.study.predict.model.Prediction toInfra(
        ...
        return com.goosage.infra.service.study.predict.model.Prediction.of(level, reason, evidence);
    }

    private static com.goosage.infra.service.study.predict.model.PredictionLevel toInfraLevel(
            com.goosage.domain.predict.PredictionLevel l
    ) {
        // infra는 SAFE / RISK 두 단계였다면 이렇게 매핑
        // WARNING/DANGER 모두 RISK로 떨어뜨리는 게 “보수적”이라 안전함
        return switch (l) {
            case SAFE -> com.goosage.infra.service.study.predict.model.PredictionLevel.SAFE;
            case WARNING, DANGER -> com.goosage.infra.service.study.predict.model.PredictionLevel.RISK;
        };
    }

    private static com.goosage.infra.service.study.predict.model.PredictionReasonCode toInfraReason(
        ...
        return switch (c) {
            case TODAY_DONE -> com.goosage.infra.service.study.predict.model.PredictionReasonCode.TODAY_DONE;
            case DATA_POOR -> com.goosage.infra.service.study.predict.model.PredictionReasonCode.DATA_POOR;
            case LOW_ACTIVITY_3D -> com.goosage.infra.service.study.predict.model.PredictionReasonCode.STABLE; // 임시
            default -> com.goosage.infra.service.study.predict.model.PredictionReasonCode.DEFAULT_FALLBACK;
        };
    }
